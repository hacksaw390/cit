					...
					<div class="row">
						<div class="col-lg-6 m-auto bg-secondary py-1">
							...
							<form action="update_user.php" method="post">
								...
								<div class="form-group">
									<input type="text" name="email" placeholder="Email" class="form-control" value="<?php echo $catch_user['email'] ?>">
								</div>
								...
								<div class="form-group">
									<input type="password" name="pass" placeholder="Password" class="form-control" value="<?php echo $catch_user['pass'] ?>">
								</div>
								...
								<div class="form-group">
									<input type="password" name="repass" placeholder="Re-password" class="form-control" value="<?php echo $catch_user['repass'] ?>">
								</div>
								...
								<div class="form-group">
									...
									<input type="submit" id="btn" value="Submit" name="btn" class="btn btn-info">
								</div>
							</form>
						</div>
					</div>
